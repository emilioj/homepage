...
** Archive
  ...
  :export_date: <2019-01-29 Tue 13:24>
  :END:
...
** Work in Progress: 20190129 :Data__Analytics:High__Performance__Data__Analytics:Numerical__Simulation:Scientific__Data:Flink:
  :PROPERTIES:
  :export_hugo_section: project
  :export_hugo_weight: 30
  :export_file_name: 2019jan_1
  ...
  :export_date: <2019-01-29 Tue 14:43>
  :END:
...
**** Student
     ...
     + Final year project, [[http://www.masterhpc.es][MSc in HPC]], UDC-USC-CESGA\\
       (TFM [[http://www.masterhpc.es][Mestrado en Computación de Altas Prestacións]], UDC-USC-CESGA)
