...
*** Reinforcement Learning multiagent system for simulating a survival environment
    ...
    (gl) Sistema multiaxente de Reinforcement Learning para simulación de contorna de supervivencia \\
    (es) Sistema multiagente de Reinforcement Learning para simulación de entorno de supervivencia
...
comparando las técnicas más recientes de /Reinforcement Learning/:
- /Q-Learning/
- /Deep Q-Learning/
- /Policy Gradients/
...
/Reinforcement Learning/ es un campo que está en auge
...
implementaciones de agentes de /Reinforcement Learning/ que están a la
orden del día.

**** Objetivos concretos

     - Análisis e implementación de diversas técnicas de
       /Reinforcement Learning/ para enfrentarlas a un caso práctico
       (véase Descripción).
     ...
     - Reproducción de los resultados de OpenAI sobre uso de
       herramientas por parte de agentes de /Reinforcement Learning/
       en un entorno competitivo multi-agente.Comparativa de los
...
**** Fases principales del trabajo
     ...
     - Análisis inicial sobre diferentes tipos de agente de
       /Reinforcement Learning/, pros, contras y viabilidad
...
***** Aplicabilidad
      ...
      /Reinforcement Learning/ en el campo de estudios superiores.
...
***** Calidad técnica
      ...
      recientes sobre entornos de /Reinforcement Learning/, empleando
